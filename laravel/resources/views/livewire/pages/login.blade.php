...
<div class="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
    ...
    @endif
    <form action="{{route('login')}}" method="post" wire:submit.prevent="login" class="space-y-4">
        @csrf
        <div>
        ...
        <button type="submit"
            class="w-full bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700">Entrar
        </button>
        <div class="text-center">
            <p>¿No tienes una cuenta? <a href="{{ route('register') }}" class="text-green-600 hover:underline">Regístrate</a></p>
        </div>
    </form>
</div>
